          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">info@reweave.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Global Operations<br />Remote-First Company</p>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                We're always excited to explore new partnerships and innovative applications 
                for our textile technologies.
              </p>
              <a 
                href="/quote" 
